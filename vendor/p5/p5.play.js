...
*
* @method animation
* @param {Animated} anim Animation to be displayed
...
function Sprite(pInst, _x, _y, _w, _h) {
  ...
  * @param {Animated} animation The preloaded animation
  */
  this.addAnimation = function(label)
  {
    ...
    else if(arguments[1] instanceof Animated)
    {
...
function Animated(pInst) {
  ...
  *
  * @method clone
  * @return {Animated} A clone of the current animation
  */
  this.clone = function() {
    var myClone = new Animated(pInst); //empty
    myClone.images = [];
...
defineLazyP5Property('Animation', boundConstructorFactory(Animated));
